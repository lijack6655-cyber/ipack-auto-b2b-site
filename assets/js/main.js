...
function showInquiryToastV25(item) {
  ...
  toast.innerHTML = `<strong>Added to RFQ</strong><span>${item.title || 'Product'} has been added.</span><a href="/quote-list">View Inquiry List</a>`;
